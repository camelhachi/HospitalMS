...
<head>
    ...
    <title>Laborant Dashboard</title>
    <!-- Tailwind CSS CDN -->
...
<nav class="bg-blue-800 p-4 shadow-lg sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center">
        <a href="dashboard.php" class="text-white text-lg font-bold">Laborant Portal</a>
        ...
        <div class="text-white flex items-center space-x-2">
            ...
            <span>Welcome, Laborant. <?= isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'User' ?></span>
