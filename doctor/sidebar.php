...
<div class="bg-blue-100">
    ...
    <!-- Room Icon -->
    <a href="analytics.php" class="mb-8 group">
        <svg class="h-10 w-10 hover:scale-110 transition transform duration-300 group-hover:underline" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
